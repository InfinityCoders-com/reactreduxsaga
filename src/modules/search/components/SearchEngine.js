...
const SearchEngine = ({onchange, author, date, type}) => {
  return (
    <div className="row">
      ...
      <div className="col-sm-6 well">
        <div className="searchInput">
          <InputText name="searchString" onchange={onchange} placeHolder="Search for issues" className='col-sm-8' style={{'position': 'relative', 'float': 'left'}} />
        </div>
